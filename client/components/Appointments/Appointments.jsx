...
const Appointments = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // NOTE: backend schema still requires patientId/doctorId.
      // Since this UI stores denormalized names, we send placeholders.
      // If you want real IDs, the next step would be adding Patient/Doctor selection.
      const payload = {
      ...
      // If editingAppointment is not present, omit ids to prevent sending undefined,
      // but the backend will reject missing required fields.
      // For now we still require real IDs to fully create records.
