											...
											<div className='flex flex-wrap gap-2'>
												{doctor.availability?.length ? (
													doctor.availability.map((a, idx) => (
														<span
															key={idx}
															className={`px-2 py-1 text-xs font-semibold rounded-md border ${statusColors[a.status] || 'bg-gray-50 border-gray-200 text-gray-700'
																}`}
														>
															{a.status}
														</span>
						...
						<form onSubmit={handleSubmit} className='space-y-4'>
							...
							<div className='grid grid-cols-2 gap-4'>
								<div>
									...
									<input
										...
										onChange={handleInputChange}
										disabled={submitting}
										className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.specialization ? 'border-red-500' : 'border-gray-300'
											}`}
							...
							<div>
								...
								<input
									...
									onChange={handleInputChange}
									disabled={submitting}
									className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.qualification ? 'border-red-500' : 'border-gray-300'
										}`}
							...
							<div className='flex justify-end space-x-3 mt-6 border-t border-gray-100 pt-4'>
								<button
									...
									disabled={submitting}
									className='px-4 py-2 text-sm text-gray-700 bg-gray-100 rounded-md hover:bg-gray-200 transition-colors disabled:opacity-50 cursor-pointer'
								>
									Cancel
								</button>
								<button
									type='submit'
									disabled={submitting}
									className='px-4 py-2 text-sm text-white rounded-md bg-linear-to-t from-sky-500 to-indigo-500 border-blue-500 transition-colors disabled:opacity-50 cursor-pointer'
								>
